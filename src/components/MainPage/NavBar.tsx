    ...
    <header className="bg-primary shadow-md">
      <nav className="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <div className="hidden md:flex space-x-6 mr-24">
          ...
          <Link href="/cakes" className="text-secondary hover:text-tertiary font-medium py-2 px-3 rounded-md hover:bg-primary/10 transition-colors">{t('cakes')}</Link>
          <Link href="/order" className="text-secondary hover:text-tertiary font-medium py-2 px-3 rounded-md hover:bg-primary/10 transition-colors">{t('order')}</Link>
